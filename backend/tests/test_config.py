...
def test_assessment_mode_validation_requires_openai_stack(tmp_path):
    settings = Settings(
        ...
        raw_html_root=tmp_path / "data/knowledge_base/raw/html",
        raw_pdf_root=tmp_path / "data/knowledge_base/raw/pdfs",
        raw_md_root=tmp_path / "data/knowledge_base/raw/markdown",
        raw_doc_root=tmp_path / "data/knowledge_base/raw",
        normalized_doc_root=tmp_path / "data/knowledge_base/normalized",
        knowledge_base_manifest_path=tmp_path / "data/knowledge_base/manifest.json",
        demo_knowledge_base_path=tmp_path / "data/demo_chunks.json",
