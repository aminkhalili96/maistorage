...
saving fresh .jsonl files to data/corpus/normalized/.

Run from the backend/ directory:
    PYTHONPATH=. pytest tests/test_rechunk_corpus.py -s -q
"""
...
def test_rechunk_all_sources():
    ...
    manifest = json.loads(settings.corpus_manifest_path.read_text()) if settings.corpus_manifest_path.exists() else {}
